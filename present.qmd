...
## Summary
* Laurentian-Acadian Northern Hardwoods and Laurentian-Acadian Northern Oak Forests are the two dominant existing vegetation types, with most vegetation height being between 15-20 m. * Most ecosystems have tree cover > 60%, with over 25% of the area being in the tree category with 70-79% canopy cover.
