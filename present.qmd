...
## Summary
* Laurentian-Acadian Northern Hardwoods and Laurentian-Acadian Northern Oak Forests are the two dominant existing vegetation types, with most vegetation height being between 15-20 m. 
* Most ecosystems have tree cover > 60%, with over 25% of the area being in the tree category with 70-79% canopy cover.
* Most trees are 15-20M tall.
...
Data from the chart below is displayed spatially on the map directly below the chart. The colors on the graph directly correspond with EVC classifications on the map. 
...
![](images/evc.png){width=100%}

## Existing Vegetation Height
Data from the chart below is displayed spatially on the map directly below the chart. The colors on the graph directly correspond with EVH classifications on the map. 
